...
class PlantDetectorNode(Node):
    def __init__(self, image_topic_name = "/camera/image_raw"):
        ...
        #self.model_path = "/home/ubuntu24/leo_ws/src/basic_ros2_extra_files/plant_detector/best_alien_plant_detector_model.pth"
