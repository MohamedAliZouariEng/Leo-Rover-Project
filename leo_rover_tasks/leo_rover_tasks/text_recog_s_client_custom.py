...
class TextRecognitionClientCustom(Node):
    ...
    def __init__(self):
        ...
        self.client = self.create_client(TextRecognitionSrv, name_service)
        ...
        self.req = TextRecognitionSrv.Request()
        self.req.label = "FOOD"
    ...
    while rclpy.ok():
        ...
        if client.future.done():
            try:
                ...
                client.get_logger().info(f'\nStart X: {response.start_x}\n'
                                         f'Start Y: {response.start_y}\n'
                                         f'End X: {response.end_x}\n'
                                         f'End Y: {response.end_y}\n')
            break
